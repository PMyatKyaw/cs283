...
1. In this assignment I asked you provide an implementation for the `get_student(...)` function because I think it improves the overall design of the database application.   After you implemented your solution do you agree that externalizing `get_student(...)` into it's own function is a good design strategy?  Briefly describe why or why not.
    ...
    > **Answer**:  I think this is a good design because getting data from a database is a common thing to do and the function abstracts all the testing you have to do while giving convenience to the programmer.
...
2. Another interesting aspect of the `get_student(...)` function is how its function prototype requires the caller to provide the storage for the `student_t` structure:
    ...
    > **ANSWER:** We are allocating memory in the stack memory which gets deallocated when outside of the function. Now, you are using the dangling pointer that has been deallocated in your program which can cause massive problems.
