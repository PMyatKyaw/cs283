...
3. Please provide a link to the repository you are using for this class.
    - [Github Link](https://github.com/PMyatKyaw/cs283)

4. Briefly describe what you want to get out of this class.
    - I want to understand more about underlying layer of the computer and I want to be at a position where I can easily write code to change some of the behaviors.

5. Briefly describe any concerns you might be having with being successful in this class (if any).
    - I haven't taken CS281 so I'm afraid I will fall behind when the professor briefly explains concept from that class.